...
@SQLDelete(sql = "UPDATE STR_DET_EMP_SCORECARD SET IS_DELETED = 1 WHERE SDE_PK_ID = ?")
@Where(clause = "IS_DELETED = 0 OR IS_DELETED IS NULL")
public class ScorecardMetaData extends BaseTenantEntity
{
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "empScorecardId")
